---
 layout: default
 url: /historys/2022/04/02/history1.html
 img: /files/img/background_7.png
 tag: history
 title: Title.
 ...
 list2: Permalink
 list3: History
 permalink: /history1-article/
---


<div class = "article-image">
  <img src="{{site.baseurl}}{{page.img}}" class ="content-img">
  <div class ="text">
...
<div class= "article">
 <div class="list">
  <ul>
      ...
      <li><a class = "remove-underline" href = "{{site.baseurl}}{{page.url}}" style="color: #343434;">{{page.list2}}</a></li>
